...
MT_weights = pickle.load(open('/home/xmi4/RippsProject/procA33_MT1_2/analysis/MSM-procA3.3MT1_cluster_150_ticdim_8-weights.pkl','rb'))
MT_weights = np.concatenate(MT_weights)

dehy_MT_totdist = []
for file in sorted(glob.glob('/home/xmi4/RippsProject/Mut1-dehydrated-new/procAMT1-3Thr3Dhb/plot/*all-dist-per-traj.npy')):
    distI = np.load(file)
    dehy_MT_totdist.append(distI)
print(len(dehy_MT_totdist))
dehy_MT_totdist = np.concatenate(dehy_MT_totdist)
dehy_MT_weights = pickle.load(open('/home/xmi4/RippsProject/Mut1-dehydrated-new/procAMT1-3Thr3Dhb/plot/MSM-procAMT1-3Thr3Dhb_cluster_80_ticdim_10-weights.pkl','rb'))
